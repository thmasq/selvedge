...
use selvedge_shared::{ActorError, MemberProfile, VerificationState, message::ToShell};
            ...
            client.add_event_handler(
                move |ev: SyncTypingEvent, room: Room, event_client: Client| {
                    ...
                    async move {
                        ...
                        let _ = sender_for_async.unbounded_send(ToShell::TypingUpdated {
                        ...
                        if !profiles.is_empty() {
                            let _ = sender_for_async
                                .unbounded_send(ToShell::ProfilesFetched { room_id, profiles });
                        }
                    }
                },
            );
